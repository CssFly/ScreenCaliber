...
Caliber.prototype.__createUserInterface = function()
{
	...
	return html = '<div class="cssfly"><a title="Toggle Caliber Settings" class="cssfly__button-toggle" id="cssfly-toggle">C<span class="cssfly__button-toggle__extended">aliber</span></a>\n'+
		   ...
		   '		<label title="X-Coordinate" class="cssfly-caliber__label">X-Position: <input id="cssfly-position-x" maxlength="5" '+
		   ...
		   '		<label title="Y-Coordinate" class="cssfly-caliber__label">Y-Position: <input id="cssfly-position-y" maxlength="5" '+
...
Caliber.prototype.__picker = function(endPicker)
{
	var scope = this, canvas = document.createElement('canvas'),
		...
		input = document.getElementById('cssfly-picker__value');
